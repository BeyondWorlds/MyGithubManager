...
6. [Logan](https://github.com/Meituan-Dianping/Logan) 日志系统
6. [dagger](https://github.com/google/dagger)

#### 实用
- [TinyPinyin](https://github.com/promeG/TinyPinyin) （搜pinyin，很多类似库）
...
## 待吸收
可能有些好的东西可以吸收，闲下来可以看看源码，抽取出有用的信息记录到自己的库
- [BasicUI是一些常用的Android UI组件和一些实用工具类封装，提高Android的开发效率](https://github.com/Peakmain/BasicUI)
- [AndroidBaseLibs基础组件库](https://github.com/devallever/AndroidBaseLibs)

## UI
1. [腾讯高效UI库](https://github.com/Tencent/QMUI_Android)
...
7. [BackgroundLibrary(2023-03)](https://github.com/JavaNoober/BackgroundLibrary)  标签直接生成shape

#### Layout
- [万能的TabLayout](https://github.com/angcyo/DslTabLayout)
- [可折叠TabLayout](https://github.com/hugeterry/CoordinatorTabLayout)
...
#### view
1. [PhotoView(图片跟随手势缩放)](https://github.com/chrisbanes/PhotoView)
2. [uCrop(图片裁剪)](https://github.com/Yalantis/uCrop)
2. [CircleImageView](https://github.com/hdodenhof/CircleImageView)
3. [DropDownMenu](https://github.com/dongjunkun/DropDownMenu)
3. [PickerView](https://github.com/Bigkoo/Android-PickerView)
4. [AndroidPicker](https://github.com/gzu-liyujiang/AndroidPicker)
4. [MaterialDateTimePicker](https://github.com/wdullaer/MaterialDateTimePicker)
5. [CalendarView](https://github.com/huanghaibin-dev/CalendarView)
4. [ShowcaseView](https://github.com/amlcurran/ShowcaseView)
5. [TapTargetView](https://github.com/KeepSafe/TapTargetView)
6. [SwitchButton](https://github.com/kyleduo/SwitchButton)
7. [ToggleButton](https://github.com/Nightonke/JellyToggleButton)

#### TextView
- [SuperTextView](https://github.com/lygttpod/SuperTextView) 各种样式的Textview
...
#### 效果
- [SeparatedEditText](https://github.com/WGwangguan/SeparatedEditText) 仿支付宝密码输入框、微信密码输入框
- [RulerView](https://github.com/zjun615/RulerView) 卷尺系列控件，包含：普通卷尺（如：体重）、金额尺、时间尺
...
4. [zxing扫码优化^](https://github.com/yuzhiqiang1993/zxing)
5. [CZXing](https://github.com/devilsen/CZXing)

## 音视频
github关键字Video、Camera、photo
...
3. [JZVideo](https://github.com/Jzvd/JZVideo)
...
6. [mobile-ffmpeg(2023-03)](https://github.com/tanersener/mobile-ffmpeg) 

#### 视频处理
- [视频录制和压缩](https://github.com/mabeijianxi/small-video-record)
- [利用FFmpeg压缩和录制](https://github.com/iknow4/Android-Video-Trimmer)


#### 图片相机相关
- [RxGalleryFinal(图片/视频选择2019/11)](https://github.com/FinalTeam/RxGalleryFinal)
- [TakePhoto（2018/4）](https://github.com/crazycodeboy/TakePhoto)
...
#### 插件
- [AS快速查询版本](https://github.com/wuyr/GoogleLibraryVersionQuerier)
## 第三方平台
...
## kotlin
- [kotlin学习汇总](https://blog.csdn.net/BeyondWorlds/article/details/78562776)
...
## 项目实战
- [Design-WanAndroid
](https://github.com/Lowae/Design-WanAndroid)
- [WanAndroidMVP](https://github.com/iceCola7/WanAndroid)
- [WanAndroidMVVM](https://github.com/lulululbj/wanandroid)
...
5. [RxKotlin](https://github.com/ReactiveX/RxKotlin)
